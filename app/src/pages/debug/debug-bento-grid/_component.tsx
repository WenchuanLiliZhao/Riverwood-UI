...
export const DebugBentoGridComponent: React.FC = () => {
  return (
    <div className={styles.debugPage}>
      ...
      >
        <BentoGrid gap="md">
          <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
            <GridItemContent label="Item 1" cols={3} rows={1} />
          </BentoItem>
          <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
            <GridItemContent label="Item 2" cols={3} rows={1} />
          </BentoItem>
          <BentoItem res={[[640, 6, 2], [1024, 6, 2], [Infinity, 6, 2]]}>
            <GridItemContent label="Large Item" cols={6} rows={2} />
          </BentoItem>
          <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
            <GridItemContent label="Item 3" cols={3} rows={1} />
          </BentoItem>
          <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
            <GridItemContent label="Item 4" cols={3} rows={1} />
          </BentoItem>
        </BentoGrid>
      </Section>
      ...
      >
        <BentoGrid gap="md">
          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <BentoItem 
              key={i} 
              res={[[640, 6, 1], [1024, 2, 1], [Infinity, 2, 1]]}
            >
      ...
      >
        <BentoGrid gap="md">
          ...
          {[1, 2, 3, 4].map((i) => (
            <BentoItem 
              key={i} 
              res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}
            >
      ...
      >
        <BentoGrid gap="md">
          <BentoItem res={[[640, 6, 1], [1024, 8, 1], [Infinity, 8, 1]]}>
      ...
      >
        <BentoGrid gap="md">
          <BentoItem res={[[640, 6, 2], [1024, 4, 3], [Infinity, 4, 3]]}>
            <GridItemContent label="Tall A" cols={4} rows={3} />
          </BentoItem>
          <BentoItem res={[[640, 6, 1], [1024, 4, 1], [Infinity, 4, 1]]}>
            <GridItemContent label="B" cols={4} rows={1} />
          </BentoItem>
          <BentoItem res={[[640, 6, 2], [1024, 4, 2], [Infinity, 4, 2]]}>
      ...
      {/* Pattern 9: Custom Row Height */}
      <Section
        title="Pattern 9: Custom Row Height"
        description="Demonstrating rowHeight prop to control minimum row height (default: 180px) with responsive items"
      >
        <div className={styles.rowHeightExamples}>
          <div>
            <h3>Default (180px)</h3>
            <BentoGrid gap="md">
              <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
          ...
          <div>
            <h3>Custom: 120px</h3>
            <BentoGrid gap="md" rowHeight={120}>
              <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
                <GridItemContent label="Item 1" cols={3} rows={1} />
              </BentoItem>
              <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
          ...
          <div>
            <h3>Custom: 250px</h3>
            <BentoGrid gap="md" rowHeight={250}>
              <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
                <GridItemContent label="Item 1" cols={3} rows={1} />
              </BentoItem>
              <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
      ...
      <Section
        ...
        description="Resize your browser window to see responsive behavior. Each item has different breakpoints to demonstrate per-item responsive configuration."
      >
        <div className={styles.responsiveContainer}>
          <BentoGrid gap="md">
            <BentoItem res={[[640, 6, 2], [1024, 6, 2], [Infinity, 6, 2]]}>
              <GridItemContent label="Large" cols={6} rows={2} />
            </BentoItem>
            <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
              <GridItemContent label="A" cols={3} rows={1} />
            </BentoItem>
            <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
              <GridItemContent label="B" cols={3} rows={1} />
            </BentoItem>
            <BentoItem res={[[640, 6, 1], [1024, 3, 1], [Infinity, 3, 1]]}>
              <GridItemContent label="C" cols={3} rows={1} />
            </BentoItem>
